...
def main():
    ...
    if task == "convert_rosbag2_to_non_annotated_t4":
        ...
        converter = AlignNonAnnotatedT4ToReferenceConverter(
            ...
            lidarseg_num_neighbors=config_dict["conversion"].get("lidarseg_num_neighbors", 5),
            lidarseg_max_neighbor_dist_m=config_dict["conversion"].get(
                "lidarseg_max_neighbor_dist_m", 1.0
            ),
            logger=logger,
        )
